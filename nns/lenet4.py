...
def tran_and_save_model(to_save_model_file='../models/lenet4-relu'):
    batch_size = 256
    epochs = 10
...
if __name__ == '__main__':
    to_save_model_file = '../models/letnet4-relu'
    tran_and_save_model(to_save_model_file)
    lenet4_model = load_model(to_save_model_file)
    lenet4_model.summary()
    plot_model(lenet4_model, to_file='../outputs/model_visualization/letnet4-relu.png', show_shapes=True)
